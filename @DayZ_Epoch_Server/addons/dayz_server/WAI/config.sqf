if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_gear0					= [["ItemBandage","ItemBandage","ItemPainkiller"],["ItemKnife","ItemGPS"]];
		ai_gear1					= [["ItemBandage","ItemBandage","ItemMorphine"],["ItemKnife","ItemFlashlight"]];
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_avoid_traders			= 650;								// avoid spawning missions this close to traders
